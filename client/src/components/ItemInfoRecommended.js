...
export default function ItemInfoRecommended({itemsRec}) {
  // console.log({itemsRec});
    return (
      ...
      <div id="itemInfoContainer">
        <div className="productImageDiv"><img id="productImage" src={itemsRec[9].imageLink} className="productImagePic" /></div>
        <div className="productCost"><b>{itemsRec[9].price} stirling</b></div>
        <div className="productName">{itemsRec[9].itemName}</div>
        </div>
        </div>
        <br></br>
