  ...
  console.log({items})
    return (
      ...
      <div id="itemInfoFrequentlyBoughtTogetherContainer">
        ...
        <div className="productCostFrequentlyBoughtTogether"><b>{items[0].price} stirling</b></div>
        <div className="productNameFrequentlyBoughtTogether">{items[0].itemName}</div>
        <br></br>
